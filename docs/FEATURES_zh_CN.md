...
**功能：**精确匹配客户端收到的本人 Radiant、Mana Flux、Overflux、Plasmaflux Power Orb，以及 Warning、Alert、SOS Flare 消失行，并以红色中央大字显示 `<Deployable Name> Despawned!!!`。功能默认开启；独立本地音效默认开启且为 64%，可用连续 0–100% 滑条调整。
