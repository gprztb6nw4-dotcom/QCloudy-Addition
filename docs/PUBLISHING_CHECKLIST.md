...
| Version | `Beta-2.9.29+26.1.2` and `Beta-2.9.29+26.2` |
...
- Upload `release/QCloudy_Addition-Beta-2.9.29+26.1.2.jar` for Minecraft 26.1.2 and `release/QCloudy_Addition-Beta-2.9.29+26.2.jar` for Minecraft 26.2.
- Use `docs/MODRINTH_RELEASE_2.9.29.md` as the concise version changelog; the Chinese companion is `docs/MODRINTH_RELEASE_2.9.29_zh_CN.md`.
...
- Title: `QCloudy_Addition Beta 2.9.29 for Minecraft 26.1.2 and 26.2`
- Use `docs/GITHUB_RELEASE_2.9.29.md` as the English release body and optionally append/link `docs/GITHUB_RELEASE_2.9.29_zh_CN.md`.
