...
- Upload `release/QCloudy_Addition-Alpha-2.8.26+26.1.2.jar` for Minecraft 26.1.2.
- Use `docs/MODRINTH_RELEASE_2.8.26.md` as the concise version changelog; the Chinese companion is `docs/MODRINTH_RELEASE_2.8.26_zh_CN.md`.
...
- Title: `QCloudy_Addition Alpha 2.8.26 for Minecraft 26.1.2`
- Use `docs/GITHUB_RELEASE_2.8.26.md` as the English release body and optionally append/link `docs/GITHUB_RELEASE_2.8.26_zh_CN.md`.
