...
> **当前通道：面向 Minecraft 26.1.2 的 Alpha 2.9.30。** 可选第三方设置/HUD 适配使用按需能力探测，不再使用精确版本白名单。
...
将 `QCloudy_Addition-Alpha-2.9.30+26.1.2.jar` 放入实例 `mods` 文件夹。不要把 `-sources.jar` 当作可运行模组安装。
