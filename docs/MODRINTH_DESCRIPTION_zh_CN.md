...
> **当前通道：面向 Minecraft 26.1.2 与 26.2 的 Beta 2.9.28。** 可选第三方设置/HUD 适配使用按需能力探测，不再使用精确版本白名单。
...
将与游戏版本匹配的 `QCloudy_Addition-Beta-2.9.28+<Minecraft 版本>.jar` 放入实例 `mods` 文件夹。不要把 `-sources.jar` 当作可运行模组安装。
