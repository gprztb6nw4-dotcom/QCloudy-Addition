...
> **当前通道：Beta 2.8.17。** 同一套 QCA 自身功能同时构建为 Minecraft 26.1.2 与 26.2 版本。可选第三方设置/HUD 适配改为能力探测，不再使用精确版本白名单。

## 核心功能

### 统一设置与 HUD 编辑——Beta

- 以功能为中心，统一管理 QCA 及已安装 SkyHanni、Skyblocker、Firmament、BabyZombieAddons 中能够安全识别的实时设置。
...
根据游戏版本，将 `QCloudy_Addition-Beta-2.8.17+26.1.2.jar` 或 `QCloudy_Addition-Beta-2.8.17+26.2.jar` 放入实例 `mods` 文件夹。不要把 `-sources.jar` 当作可运行模组安装。
